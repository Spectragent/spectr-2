            ...
            <div className="grid gap-4">
              <div className="space-y-2 mt-2 text-center">
                <div className="flex justify-center">
                  <img src={logo} alt="Spectr.ai" title="Spectr.ai" className="w-12 h-12" />
                </div>
                <div className="flex justify-center">
                  <p className="text-sm text-muted-foreground justify-center mb-2">
                    Version v1.2.2 by{' '}
                    <a
                      href="https://github.com/metaspartan/spectr"
                      onClick={e => {
                        e.preventDefault();
                        tauriOpen('https://github.com/metaspartan/spectr');
                      }}
                ...
                <strong>Spectr.ai</strong> is an infinite canvas for your thoughts—a platform that
