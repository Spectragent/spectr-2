        ...
        <DialogHeader>
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <img src={logo} alt="Spectr.ai" className="relative w-20 h-20 animate-fade-in" />
            </div>
          </div>
        ...
        <div className="space-y-6 mt-4">
          <div className="space-y-4">
            <p className="text-center leading-relaxed">
              Transform your thinking process with an infinite AI-powered canvas that grows with
              your imagination. Connect ideas, explore concepts, and create knowledge networks with
              ease.
            </p>
