          ...
          <div className="grid gap-4">
                ...
                <Select
                  ...
                  onValueChange={value => {
                    ...
                    setNewModel({
                      ...
                      name:
                        preset && preset.name !== 'Custom' ? `${preset.name} Model` : newModel.name,
                      ...
                      {newModel.endpoint && (
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex flex-col">
                            <span>
                              {PRESET_ENDPOINTS.find(p => p.url === newModel.endpoint)?.name}
                            </span>
                          </div>
                        </div>
                      )}
            ...
            <div className="flex items-center gap-2">
              <Switch
                ...
                onCheckedChange={checked => setNewModel({ ...newModel, requiresAuth: checked })}
              />
